...
import serviceImg from "../assets/images/residential_banner.jpg"; // 👈 put your image in src/assets/

const ResidentialBannerSection = () => {
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center">
        ...
        <div>
          ...
          <p className="text-white text-base md:text-lg leading-relaxed">
            We provide high-quality Residential solutions designed to fit your
...
export default ResidentialBannerSection;
